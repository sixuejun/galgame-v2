...
export const liquidGlassTheme: ThemeDefinition = {
  ...
  cssVars: {
    ...
    '--theme-choice-btn-inner-gap': '0.5em',
    '--theme-choice-btn-inner-padding-top': '0.15rem',
    '--theme-choice-btn-inner-padding-bottom': '0.15rem',

    // 选项按钮
    '--theme-choice-btn-bg': 'rgba(255, 255, 255, 0.18)',
    '--theme-choice-btn-border': 'rgba(255, 255, 255, 0.25)',
    '--theme-choice-btn-shadow': '0 4px 16px rgba(0, 0, 0, 0.2)',
    '--theme-choice-btn-hover-bg': 'rgba(96, 165, 250, 0.25)',
    '--theme-choice-btn-hover-border': 'rgba(255, 255, 255, 0.4)',
    '--theme-choice-btn-hover-shadow': '0 4px 20px rgba(96, 165, 250, 0.3)',
    '--theme-choice-btn-selected-bg': 'rgba(96, 165, 250, 0.35)',
    '--theme-choice-btn-selected-border': 'rgba(96, 165, 250, 0.6)',
    '--theme-choice-btn-selected-shadow': '0 4px 20px rgba(96, 165, 250, 0.3)',
    '--theme-choice-letter-color': '#93c5fd',
    '--theme-choice-letter-color-hover': '#bfdbfe',
    '--theme-choice-text-color': '#ffffff',
    '--theme-choice-text-color-hover': '#ffffff',
    '--theme-choice-text-color-selected': '#bfdbfe',
    '--theme-choice-text-font-family': "'Inter', 'PingFang SC', 'Microsoft YaHei', sans-serif",
    '--theme-choice-text-font-size': '1em',
    '--theme-choice-text-font-weight': '500',
    '--theme-choice-text-line-height': '1.5',
    '--theme-choice-text-letter-spacing': '0.02em',
    '--theme-choice-text-placeholder-color': 'rgba(255, 255, 255, 0.4)',
    '--theme-choice-caret-color': '#93c5fd',

    // 自由输入选项悬浮发送按钮
    '--theme-choice-send-btn-color': 'rgba(96, 165, 250, 0.7)',
    '--theme-choice-send-btn-hover-color': 'rgba(96, 165, 250, 1)',
    '--theme-choice-send-btn-disabled-color': 'rgba(255, 255, 255, 0.25)',

    // 输入面板
    '--theme-input-backdrop': 'rgba(0, 0, 0, 0.2)',
    '--theme-input-title-color': 'rgba(255, 255, 255, 0.9)',
    '--theme-input-send-btn-bg': 'rgba(96, 165, 250, 0.8)',
    '--theme-input-send-btn-border-color': 'rgba(96, 165, 250, 0.5)',
    '--theme-input-send-btn-color': '#ffffff',
    '--theme-input-send-btn-disabled-bg': 'rgba(255, 255, 255, 0.1)',
    '--theme-input-send-btn-disabled-color': 'rgba(255, 255, 255, 0.35)',
    '--theme-input-textarea-color': 'rgba(255, 255, 255, 0.9)',
    '--theme-input-textarea-bg': 'rgba(255, 255, 255, 0.12)',
    '--theme-input-textarea-border': 'rgba(255, 255, 255, 0.2)',
    '--theme-input-textarea-placeholder-color': 'rgba(255, 255, 255, 0.4)',
    '--theme-input-textarea-padding-top': '0.5rem',
    '--theme-input-textarea-padding-right': '0.5rem',
    '--theme-input-textarea-padding-bottom': '0.5rem',
    '--theme-input-textarea-padding-left': '0.75rem',
    '--theme-input-send-btn-right': '0.5rem',
    '--theme-input-send-btn-bottom': '0.5rem',
    '--theme-input-close-btn-color': 'rgba(255, 255, 255, 0.5)',
    '--theme-input-close-btn-hover-color': 'rgba(255, 255, 255, 0.9)',
